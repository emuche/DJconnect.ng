          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
            ...
            <?php if(Logged::in() && (Session::check('id', $data['user']->id) || Session::check('email', $data['user']->email))): ?>
              ...
              <div class="d-grid gap-2 col-6 mx-auto mb-5">
                <a href="<?=Redirect::link('posts/edit', $data['post']->title, $data['post']->id) ?>" class="btn btn-primary">Edit Post</a>
              </div>
              ...
              <div class="meta-top">
                <ul>
                  ...
                  <li class="d-flex align-items-center"><i class="bi bi-music-note-list"></i> <a href="<?= Redirect::link('genres', $data['genre']->title, 'page/1') ?>"><?= $data['genre']->title ?></a></li>
            ...
            <div class="comments">
              ...
              <div class="reply-form">
                ...
                <?php if(Session::exists('comment_success')): ?>
                  <div class="alert alert-success alert-dismissible fade show" role="alert">
                      <?= Session::flash('comment_success') ?>
                      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
              <?php endif; ?>

              <?php if(Session::exists('comment_failed')): ?>
                  <div class="alert alert-danger alert-dismissible fade show" role="alert">
                      <?= Session::flash('comment_failed') ?>
                      <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div>
              <?php endif; ?>
                ...
                <form action="<?= Redirect::link('details', $data['post']->title, $data['post']->id ) ?>" method="post">
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input name="name" type="text" class="form-control <?= (!empty($data['name_err'])) ? 'is-invalid' : '' ?>" placeholder="Your Name*" value="<?= $data['name'] ?>">
                      <span class="invalid-feedback"><?= $data['name_err'] ?></span>
                    </div>
                    <div class="col-md-6 form-group">
                      <input name="email" type="text" class="form-control <?= (!empty($data['email_err'])) ? 'is-invalid' : '' ?>" placeholder="Your Email*" value="<?= $data['email'] ?>">
                  ...
                  <div class="row">
                    <div class="col form-group">
                      <input name="website" type="text" class="form-control" placeholder="Your Website" value="<?= $data['website'] ?>">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                      <textarea name="comment" class="form-control <?= (!empty($data['comment_err'])) ? 'is-invalid' : '' ?>" placeholder="Your Comment*" value="<?= $data['content'] ?>"></textarea>
                      <span class="invalid-feedback"><?= $data['comment_err'] ?></span>
