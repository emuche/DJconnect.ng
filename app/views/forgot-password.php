                        ...
                        <div class="row">
                            ...
                            <div class="col mx-auto">
                                ...
                                <div class="card card-body bg-light mt-5">
                                    ...
                                    <p>Please fill in your email or username to recover account.</p>
                                    <form action="<?= URLROOT ?>/forgotpassword" method="post">
                                    <div class="">
                                    ...
                                    <div class="row mt-3 ">
                                        <div class="col">
                                        <input type="submit" class="btn btn-success btn-block" value="Recover">
                                        </div>
                                    </div>
                                    </form>
                                </div>
