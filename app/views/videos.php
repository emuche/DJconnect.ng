            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-md-6">
                        ...
                        <h2 class="title">
                            <a href="<?= Redirect::link('details',$post->title,$post->postId) ?>"><?= $post->title ?></a>
                        </h2>
                        ...
                        <div class="meta-top">
                            ...
                            <li class="d-flex align-items-center"><i class="bi bi-music-note-list"></i> <a href="<?= Redirect::link('post/genre', $post->genre, $post->genreId) ?>"><?= $post->genre ?></a></li>


                            <?php  if($post->mix_type == 'audio/mpeg'): ?>
                                <li class="d-flex align-items-center"><i class="bi bi-file-earmark-music"></i> <a href="<?= Redirect::link('audio', $post->genre) ?>"> Audio</a></li>
                            <?php elseif($post->mix_type == 'video/mp4'): ?>
                                <li class="d-flex align-items-center"><i class="bi bi-camera-video"></i> <a href="<?= Redirect::link('video', $post->genre) ?>"> Video</a></li>
                            <?php endif; ?>
                        ...
                        <div class="read-more mt-auto align-self-end">
                            <a href="<?= Redirect::link('details', $post->title, $post->postId) ?>">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    ...
                    <ul class="justify-content-center">
                        <li class="active"><a href="<?= Redirect::link('videos/1') ?>">1</a></li>
                        <li><a href="<?= Redirect::link('videos/2') ?>">2</a></li>
                        <li><a href="<?= Redirect::link('videos/3') ?>">3</a></li>
                        <li><a href="<?= Redirect::link('videos/4') ?>">4</a></li>
                    </ul>
