        ...
        <main id="main">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    <h1 class="display-6 mb-5 "><a href="<?= Redirect::link('profiles', $data['dj']->username)?>"><?= ucwords($data['dj']->name) ?>'s</a>  
                    
                    <?php if($data['post_type'] == 'videos'): ?>
                        Videos
                    <?php elseif($data['post_type'] == 'audios'): ?>
                        Audios
                    <?php else: ?>
                        Mixtapes
                    <?php endif; ?>
                    ...
                    <ul class="justify-content-center">
                        <li class="active"><a href="<?= Redirect::link('profiles', $data['dj']->username, '1') ?>">1</a></li>
                        <li><a href="<?= Redirect::link('profiles', $data['dj']->username, '2') ?>">2</a></li>
                        <li><a href="<?= Redirect::link('profiles', $data['dj']->username, '3') ?>">3</a></li>
                        <li><a href="<?= Redirect::link('profiles', $data['dj']->username, '4') ?>">4</a></li>
                    </ul>
