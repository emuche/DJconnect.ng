            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-md-6">
                        ...
                        <h2 class="title">
                            <a href="<?= Redirect::link('details', $post->postTitle, $post->postId) ?>"><?= $post->postTitle ?></a>
                        </h2>
                        ...
                        <div class="meta-top">
                            ...
                            <li class="d-flex align-items-center"><i class="bi bi-music-note-list"></i> <a href="<?= Redirect::link('genres', $post->genreTitle,'page/1') ?>"><?= $post->genreTitle ?></a></li>
                        ...
                        <div class="read-more mt-auto align-self-end">
                            <a href="<?= Redirect::link('details', $post->postTitle, $post->postId) ?>">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    ...
                    <ul class="justify-content-center">
                        ...
                        <li class="active"><a href="<?= Redirect::link('genres', $data['genre']->title,  'page/1') ?>">1</a></li>
                        <li><a href="<?= Redirect::link('genres', $data['genre']->title,  'page/2')  ?>">2</a></li>
                        <li><a href="<?= Redirect::link('genres', $data['genre']->title,  'page/3') ?>">3</a></li>
                        <li><a href="<?= Redirect::link('genres', $data['genre']->title,  'page/4') ?>">4</a></li>
                    </ul>
