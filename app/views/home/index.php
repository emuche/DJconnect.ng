            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <ul class="justify-content-center">
                        <li class="active"><a href="<?= Redirect::link('home/page/1') ?>">1</a></li>
                        <li><a href="<?= Redirect::link('home/page/2') ?>">2</a></li>
                        <li><a href="<?= Redirect::link('home/page/3') ?>">3</a></li>
                        <li><a href="<?= Redirect::link('home/page/4') ?>">4</a></li>
                    </ul>
